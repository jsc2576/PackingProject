...
함수
 - void addFragments(Fragment...) : 프래그먼트들을 한 번에 여러 개 넣는 함수입니다.
 - void addFragment(int position, Fragment) : 원하는 위치에 프래그먼트를 넣는 함수입니다.
 - void removeFragment(int) : 원하는 위치의 fragment를 삭제하는 함수입니다.
 - void addFragmentTitles(String ...) : fragment들의 title을 설정하는 함수입니다. tablayout과 연동할 때 사용합니다.
 - void addFragmentTitle(int position, String title) : 원하는 위치에 title을 추가합니다.
 - void setFragmentTitle(int position, String title) : 원하는 위치의 title을 변경합니다.
 - void removeFragmentTitle(int position) : 원하는 위치의 title을 삭제합니다.
...
// ====tablayout과 연동==== //
        ...
        viewPager = (PackViewPager)findViewById(R.id.viewpager);

        viewPager.addFragments(new FirstFragment(), new SecondFragment());
        viewPager.addFragmentTitles("first title", "second title");
